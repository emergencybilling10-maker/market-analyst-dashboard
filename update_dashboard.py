...
def get_market_analysis():
    # 2. Fetch Live Market Data (Example: Nifty 50 and Bitcoin)
    # You can change these tickers to anything you want to track
    ...
    Format your response in clean HTML bullet points.
    """
            ...
            <main class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-slate-800 p-6 rounded-lg border border-slate-700">
                        ...
                        <span class="inline-block mt-2 px-2 py-1 text-xs rounded font-bold { 'bg-emerald-950 text-emerald-400' if nifty_change >= 0 else 'bg-rose-950 text-rose-400' }">
                    ...
                    <div class="bg-slate-800 p-6 rounded-lg border border-slate-700">
                        ...
                        <span class="inline-block mt-2 px-2 py-1 text-xs rounded font-bold { 'bg-emerald-950 text-emerald-400' if btc_change >= 0 else 'bg-rose-950 text-rose-400' }">
